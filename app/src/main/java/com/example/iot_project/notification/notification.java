...
public class notification extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("hengio".equals(intent.getAction()) || "ketthuc".equals(intent.getAction())) {
            ...
            String detail = "Hẹn giờ: máy bơm tưới cây khu vực " + area + " " + ("hengio".equals(intent.getAction()) ? "được bật" : "kết thúc tưới");
            addItemAndReload(timePicker, detail);

            String notificationTitle = "Hẹn giờ thành công " + datePicker;
            String notificationText = "Khu vực " + area + " " + ("hengio".equals(intent.getAction()) ? "bắt đầu tưới" : "kết thúc tưới");
